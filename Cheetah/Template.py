...
import types                      # used to bind methods and create dummy modules
import string
import os.path
    ...
    def compile(klass, source=None, file=None,
        ...
        if not returnAClass:
            ...
            try:
                ...
                mod = types.ModuleType(uniqueModuleName)
                if moduleGlobals:
    ...
    def _addCheetahPlumbingCodeToClass(klass, concreteTemplateClass):
        ...
        for methodname in klass._CHEETAH_requiredCheetahMethods:
            if not hasattr(concreteTemplateClass, methodname):
                ...
                # Python 3: no need for instancemethod wrapper
                newMethod = method
